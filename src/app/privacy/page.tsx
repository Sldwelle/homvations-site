  ...
  return (
    <div className="min-h-screen bg-[#0a0e14] text-[#f2f5f6] font-sans">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <h1 className="text-4xl font-black mb-6 text-[#f2f5f6]">Privacy Policy</h1>
        ...
        <div className="space-y-6 text-[rgba(242,245,246,0.75)] leading-relaxed font-medium">
          ...
          <h2 className="text-2xl font-black text-purple-300 pt-4">Information We Collect</h2>
          <p>
          ...
          <h2 className="text-2xl font-black text-purple-300 pt-4">How We Use Your Information</h2>
          <p>
          ...
          <h2 className="text-2xl font-black text-purple-300 pt-4">Your Choices</h2>
          <p>
          ...
          <h2 className="text-2xl font-black text-purple-300 pt-4">Contact</h2>
          <p>
